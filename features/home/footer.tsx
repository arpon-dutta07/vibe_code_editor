  ...
  return (
    <footer className="relative bg-zinc-950 overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start gap-14 lg:gap-0 lg:justify-between">
          ...
          <div className="max-w-[280px]">
            <div className="flex items-center gap-2.5 mb-7">
              ...
              <span className="text-sm font-bold text-white tracking-tight">VibeCode</span>
            </div>

            <p className="text-[13px] text-zinc-500 leading-relaxed mb-9">
              AI-native code editor for developers who value speed, flow, and creative control.
            </p>

            <Link
              href="/dashboard"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-white/12 text-[13px] font-semibold text-white hover:bg-white/[0.07] hover:border-white/20 transition-all duration-200 active:scale-[0.97]"
            >
              Start building free
          ...
          <div className="flex gap-16 sm:gap-24">
            <div>
              <p className="text-[9px] font-bold uppercase tracking-[0.26em] text-zinc-600 mb-6">
                Navigate
              </p>
            ...
            <div>
              ...
              <nav className="flex flex-col gap-4">
                ...
                <span className="block h-px bg-zinc-800/60 w-full my-1" />
      ...
      <div className="relative z-10 overflow-hidden">
        ...
        <p
          className="font-black text-white leading-[0.80] pl-4 sm:pl-6 -mb-[0.1em] select-none"
          style={{
